 ...
 * interface.
 */
public class BeneficiaryListFragment extends ListFragment implements IJSONNetworkActivity{

	public static final int ACTION_GETBENEFICIARIES = 1;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("onCreate", Util.BASE_URL+Util.URL_GET_BENEFICIARIES);
		new JSONAsyncTask(Util.BASE_URL+Util.URL_GET_BENEFICIARIES, this, ACTION_GETBENEFICIARIES).execute();
	}
		...
		if (null != pJSONString){
			try {
				...
				for(int i=0; i< jsonArray.length();i++){
					...
					DummyContent.ITEMS.add(new DummyItem(""+jsonObj.getLong("id"), jsonObj.getString("name")+"-"+jsonObj.getString("accountHolder")));
				}
