 ...
 * interface.
 */
public class AccountListFragment extends ListFragment implements IJSONNetworkActivity{

	public static final int ACTION_GETACCOUNTS = 0;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("onCreate", Util.BASE_URL+Util.URL_GET_ACCOUNTS);
		new JSONAsyncTask(Util.BASE_URL+Util.URL_GET_ACCOUNTS, this, ACTION_GETACCOUNTS).execute();
	}
		...
		if (null != pJSONString){
			try {
				...
				for(int i=0; i< jsonArray.length();i++){
					...
					DummyContent.ITEMS.add(new DummyItem(""+jsonObj.getLong("id"), jsonObj.getString("iban")));
				}
