...
public class AccountDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(AccountDetailFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(AccountDetailFragment.ARG_ITEM_ID));
			AccountDetailFragment fragment = new AccountDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.account_detail_container, fragment).commit();
		}
	}
